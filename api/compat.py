...
FRASES = {
  'dog': {
    'energia': [
      ...
      "Você fala 'calma'. Eu escuto 'vai mais rápido'.",
      "Ouvi um barulho que não existe. Já estou reagindo.",
    ...
    'sofa': [
      ...
      "Você levanta, eu pego o lugar. Isso aqui é dinâmica natural.",
    ...
    'amorodeio': [
      ...
      "Confio em você. Menos quando você fala 'é rapidinho'.",
    ],
    'cumplicidade': [
      ...
      "Você sentou no chão. Eu já vim. Isso é automático.",
    ],
  },
  'cat': {
    'energia': [
      ...
      "Empurrei. Caiu. Olhei pra você. Seguimos.",
    ...
    'sofa': [
      ...
      "Você saiu. Eu dormi. Você voltou. Eu continuei dormindo.",
    ...
    'cumplicidade': [
      ...
      "Você achou que ninguém percebeu. Eu percebi.",
