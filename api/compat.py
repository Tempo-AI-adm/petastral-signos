...
FRASES = {
  'dog': {
    'energia': [
      "Saio correndo quando você pega a guia. Sou profissional nisso.",
      "Você chegou em casa e eu agi como se tivesse voltado da guerra. Você foi no mercado.",
      "Latei pro entregador, pro vizinho, pro vento. Proteção máxima.",
      "A guia saiu da gaveta. Já estou na porta. Não precisa nem falar.",
      "Pedi pra passear 12 vezes. Na 13ª você cedeu. Isso não vai mudar.",
      "Você falou 'passear' em voz baixa do outro lado da casa. Eu ouvi. Já estava pronto.",
      "Comi o chinelo esquerdo. O direito está como garantia.",
    ...
    'sofa': [
      ...
      "Ocupo 80% da cama. Você dobra o corpo pra caber no canto. Isso é amor seu.",
      "A gente assistiu a mesma série 3 vezes. Eu nunca reclamo. Você também não.",
      "Você ronca. Eu finjo não ouvir. Estamos quites.",
      "Durmo 14 horas por dia e ainda assim pareço ocupado. É questão de postura.",
      "Você trabalha no computador. Eu deito no computador. Produtividade igual.",
      "Fiquei esperando você voltar por 4 horas. Quando chegou, fingi que tava dormindo. Orgulho tem preço.",
      "Você me acordou pra nada. Mas perdoei porque você trouxe o petisco.",
    ],
    'amorodeio': [
      "Você disse 'não' com a boca mas seus olhos disseram 'pode vir'.",
      ...
      "Derrubei uma coisa. Olhei pra você. Saí andando. Isso tem nome e não é culpa.",
      "Me chamou de gordo no veterinário. Na frente de todo mundo. Registrei.",
      "Você me colocou no banho cantando. Odiei cada segundo. Mas fiquei quieto porque gosto de você.",
    ],
    'cumplicidade': [
      ...
      "Toda vez que você sai eu acho que é pra sempre. Ainda não aprendi.",
      "Sento no seu colo na hora que você mais precisa trabalhar. É intencional.",
      "Você fala pro celular mas eu sei que é pra mim.",
      "Não preciso de motivo pra ficar do seu lado. Mas o petisco ajuda.",
    ],
  },
  'cat': {
    'energia': [
      ...
      "Empurrei o objeto da mesa. Lentamente. Com contato visual. Isso é comunicação.",
      "Você fecha a porta do banheiro. Fico do lado de fora arranhando. A porta vai ceder antes de mim.",
      "Acordei você às 4h porque queria atenção. Quando você acordou, fui embora. Não era mais urgente.",
      "Joguei seu fone do criado-mudo. Estava no caminho.",
      "Você organizou a prateleira. Eu desordenei. Isso se chama feedback.",
    ],
    'sofa': [
      ...
      "Me mudei pra cima do seu notebook. Não é falta de espaço. É posicionamento.",
      "Você ligou o aspirador de pó. Fui pra debaixo da cama. Voltei quando acabou. Não houve discussão.",
      "Sou independente. Mas também tô aqui do seu lado às 11 da noite. Faz o que quiser com essa informação.",
      "A caixa de papelão chegou com a encomenda. A encomenda foi esquecida. Isso diz tudo.",
      "Você acha que me escolheu. Eu deixei você achar isso.",
    ],
    'amorodeio': [
      "Morder sua mão faz parte do afeto. Você ainda não entendeu mas vai.",
      ...
      "Ronronei no seu colo por 40 minutos e fui embora sem aviso. Sou assim.",
      "Você me deu o petisco errado. Comi. Mas registrei.",
      "Me acariciou 3 vezes seguidas. Na 4ª eu mordi. Existe um limite. Você passou.",
      "Fui carinhoso com você por 10 minutos. Agora preciso de 3 horas sozinho pra me recuperar.",
      "Você tentou me pegar no colo. Eu fugi. Cinco minutos depois fui eu que subi. Nos meus termos.",
    ],
    'cumplicidade': [
      ...
      "Você pensa que sou independente. Mas monitoro cada passo seu dentro de casa.",
      "Fingi que tava dormindo quando você chegou. Mas eu sabia. Sempre sei.",
      "Você come, eu fico olhando. É amor ou estratégia? Os dois.",
      "Sento perto de você sem encostar. Distância calculada. Carinho com dignidade.",
    ],
  },
}
